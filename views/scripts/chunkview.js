(function() {
  ...
  ChunkView = (function() {
    ...
    ChunkView.prototype.addPoint = function(p) {
      var block, p3;
      p3 = calcPoint(p, this.options);
      this.vertices.push(p3);
      block = this.getBlockType(p[0], p[1], p[2]);
      this.colors.push(block.rgba);
    };
    ...
    ChunkView.prototype.lightBlock = function(p) {
